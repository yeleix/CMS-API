...
RSpec.describe ContractorsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new contractor" do

        post :create, params: {contractor: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(contractor_url(Contractor.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new contractor" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the contractor" do
        contractor = Contractor.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the contractor" do
        contractor = Contractor.create! valid_attributes
